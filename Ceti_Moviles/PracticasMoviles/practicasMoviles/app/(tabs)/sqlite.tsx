import { useEmpleados } from "@/hooks/useSQLite/useEmpleados";
...
export default function SQLiteScreen() {
    const { empleados, agregar, buscar, actualizar, borrar } = useEmpleados();
    ...
    const handleAgregar = async () => {
        ...
        Alert.alert("Éxito", "Empleado registrado");
        limpiar();
    };
    ...
    const handleBuscar = async () => {
        ...
        const emp = await buscar(parseInt(numemp));
        if (emp) {
